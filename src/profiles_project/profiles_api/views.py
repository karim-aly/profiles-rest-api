...
class HellpApiView(APIView):
    ...
    def post(self, request):
        """Creates a Hello message with provided name"""

        serializer = serializers.HelloSerialzier(data=request.data)
    ...
    def patch(self, request, pk=None):
        """Patch request, only update provided fields in the request"""
